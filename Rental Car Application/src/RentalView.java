...
///////////////////////////////////////////////receipt/////////////////////////////////////
	...
	//-------------------------------------------------setting PANEL and LABELS for Welcome section
	    ...
	    ImageIcon titleImage = new ImageIcon("C:\\Users\\aarti\\IdeaProjects\\Rental Car\\images\\logo_F.gif");
		titleL = new JLabel(titleImage);
		titleL.setBounds(100, 190, 230, 180);
		mainP.add(titleL);
	...
	//------------------------------------BUTTONS to go reserve section
		ImageIcon mainNextImage = new ImageIcon("C:\\Users\\aarti\\IdeaProjects\\Rental Car\\images\\next.GIF");
	...
	//--------------------------------------to go customer section
		ImageIcon dateNextImage = new ImageIcon("C:\\Users\\aarti\\IdeaProjects\\Rental Car\\images\\customer.GIF");
	...
	//---------------------------------------------------to go back welcome section
		ImageIcon dateBackImage = new ImageIcon("C:\\Users\\aarti\\IdeaProjects\\Rental Car\\images\\back.GIF");
	...
	//---------------------------------------------LEBELS for customer details
		...
		showAgeL.setBounds(145, 305, 60, 30);
	...
	//-------------------------------------TEXT FIELD for customer details and get data from keyboard section
		...
		lisnoTF.setBounds(150,270,250,30);
		...
		lisnoChecker.setBounds(410,235,100,100);
		customerP.add(lisnoChecker);

	//-------------------------------------------BUTTONS for customer
	//----------------------------------------------to go pick a car section
		ImageIcon customerNextImage = new ImageIcon("C:\\Users\\aarti\\IdeaProjects\\Rental Car\\images\\customer.GIF");
	...
	//--------------------------------------------to go back reserve section
		ImageIcon customerBackImage = new ImageIcon("C:\\Users\\aarti\\IdeaProjects\\Rental Car\\images\\customer_back.GIF");
	...
	//---------------------------------------------------------Pick Car Buttton]
	//-------------------------------------first car button
		ImageIcon firstCarImage = new ImageIcon("C:\\Users\\aarti\\IdeaProjects\\Rental Car\\images\\van.gif");
	...
	//---------------------------------second car button
		ImageIcon secondCarImage = new ImageIcon("C:\\Users\\aarti\\IdeaProjects\\Rental Car\\images\\pickup.GIF");
	...
	//---------------------------------------third car button
		ImageIcon thirdCarImage = new ImageIcon("C:\\Users\\aarti\\IdeaProjects\\Rental Car\\images\\jeepney.gif");
	...
	//------------------------------------------forth car button
		ImageIcon forthCarImage = new ImageIcon("C:\\Users\\aarti\\IdeaProjects\\Rental Car\\images\\limousine.gif");
	...
	//-------------------------------------------------to go receipt section (Final step)
		ImageIcon carNextImage = new ImageIcon("C:\\Users\\aarti\\IdeaProjects\\Rental Car\\images\\submit.GIF");
	...
	//--------------------------------------------------------------------to go back customer section
		ImageIcon carBackImage = new ImageIcon("C:\\Users\\aarti\\IdeaProjects\\Rental Car\\images\\car_back.GIF");
	...
	///////////////last panel "receipt" ////////////////////////
		...
		b1.addActionListener(new exitCarButton());
		b1.setRolloverEnabled(true);
		b1.setBounds(330, 450, 100, 50);
	...
	private class exitCarButton implements ActionListener
	{
		@Override
...
/*
			String url="jdbc:mysql://localhost:3306/RCAR";
			String user="root";
			...
			try{
				...
				String sql="INSERT INTO CUSTOMER"+
						"(FIRST_NAME,LAST_NAME,GENDER,LOCATION,CONTACT,LICENSE)"+
						"VALUES('"+firstName+"','"+lastName+"','"+gender+"','"+location+"','"+contact+"','"+license+"')";
				s.execute(sql);
		...
		public void actionPerformed(ActionEvent event) {
			...
			if(event.getActionCommand().equals("Car1")) { //passing the pick-up details to car details class and final transactions.
				...
				if(openWarningCar == null){
					...
					ImageIcon warningCarImage = new ImageIcon("C:\\Users\\aarti\\IdeaProjects\\Rental Car\\images\\warning_top_icon.GIF");
